...
def leaderboards_400_data():
    ...
    with open('leaderboards_ronin.csv','w') as f:
        pass

    with open('leaderboards_ronin.csv','a') as f:
        
        for items in fetched_data['items']:
            ronin = items["client_id"]
            f.writelines(f'{ronin}\n')

            with open('leaderboards_axies.csv','w') as f:
                pass
...
def get_player_axies(ronin):
    ...
    if battle_data['first_client_id'] == ronin:
        ...
        with open('leaderboards_axies.csv','a') as f:
